...
\begin{revision}\label{revision:dual-unit-ball}
...
\begin{theorem}
    ...
    \begin{enumeratetheorem}
        \item $T' \in \contoperators{Y'}{X'}$, so $T'$ is linear and bounded. \\
            \note{This implies $\forall y' Y': T'y' \in X'$.}
    ...
    \begin{enumerateproof}
        ...
        \item
            ...
            \begin{align*}
                ...
                &= \sup_{\norm{X}{x} \le 1}\sup_{\norm{}{y'} \le 1}{\abs{y'(Tx)}}       \explainstep{apply revision\ \ref{revision:dual-unit-ball}} \\
...
\begin{example}\label{example:shift-operator}

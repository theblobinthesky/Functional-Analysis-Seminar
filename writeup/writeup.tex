...
\newcommand{\closedunitball}[1]{\ensuremath{B_#1}}
...
% Ideen von Jakob:
% Theorem/Revision texte sollten nicht kursiv sein! 
% Case distinctions in proofs müssen auf dem selben inline niveau sein! Evtl gar kein proof environment!
% Zwischen zwei multiplizierten Normen immer einen \cdot
% supremum nie im fließtext. insgesamt sollte man statt $...$ $$..$$ verwenden und statt align $$...$$
% Konsistent immer Let ... . We then prove ... statt "We can now evaluate the expression on ..."
% Einheitlich eine Art von aufzählung benutzen. Eher itemize statt enumerate.
% Das mit der invertierung des embeddings ist inkorrekt.
% Notes müssen besser formatiert sein.
% Insgesamt Definition 4 z.B., Revisions entweder ganz an den Anfang 
% Beim langen Fließtext das \left(\\newline \\ konstrukt verwenden.
% Keine ! im Fließtext.
% Closed ball braucht leerzeichen nach den ","
% Konsistent entweder Tx oder T(x) schreiben!

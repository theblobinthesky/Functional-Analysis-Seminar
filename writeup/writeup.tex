...
% TODO: Motivate with linear algebra.
...
\begin{definition}
    ...
    \begin{romanenum}
        ...
        \item Let $J_x: X' \rightarrow \thefield, x' \mapsto x'(x)$ and $J: X \rightarrow X'', x \mapsto J_x$.
            $J$ is called the \highlight{canonical embedding} from $X$ into $X''$.
    \end{romanenum} 
\end{definition}
...
\begin{theorem}[The Operator, Adjunct Operator and the Canonical Embeddings]
\end{theorem}
\begin{proof}
\end{proof}

...
\begin{frame}{Definition: Dual Space and Closed Unit Ball}
    \begin{definition}
        Let \normedspace{X}, \normedspace{Y} and \normedspace{Z} be normed \thefield-vector spaces
        \begin{itemize}
            \item[ii)] The (topological) dual space is defined as \[ X' \defeq \dualspace{X} \]
            \item[iii)] The closed unit ball in \normedspace{X} is abbreviated with \closedunitball{X}.
        \end{itemize}
    \end{definition}
\end{frame}

\begin{frame}{Revision: Foundational Statements (i)}
...
\begin{frame}{Revision: Foundational Statements (ii)}
    \begin{block}{Revision}
        Let \twonormedspaces.
        \begin{itemize}
...
\begin{frame}{Revision: Foundational Statements -- Proof}
    \begin{proof}
        \refertolecture
    \end{proof}
\end{frame}
...
\begin{frame}{Remark: Adjoint Operator}
    \begin{block}{Remark}
...
\begin{frame}{Example: Adjoint of Matrix Operator -- Setup}
    \begin{example}
...
\begin{frame}{Example: Adjoint of Matrix Operator -- Calculation}
    \begin{example}
...
\begin{frame}{Example: Adjoint of Matrix Operator -- Conclusion}
    \begin{example}

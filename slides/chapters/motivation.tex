\begin{frame}{Motivation}
    ...
    \begin{itemize}
        \item The general version of the operator $\cdot^H$ is linear and isometric wrt. the spectral norm.
        \item The general version of the fundamental theorem of linear algebra (Gilbert Strang) or rank-nullity theorem:
            $(\im A)^\perp = \ker A^H$.
        \item How the adjoint operation behaves on compact operators.

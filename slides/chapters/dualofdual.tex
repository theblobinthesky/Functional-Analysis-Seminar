...
\begin{frame}{Introduction}
    For starters, we need to recall some concepts from the lecture.
\end{frame}
...
\begin{frame}{Theorem: Bidual Adjoint Embedding -- Proof Signatures}
    \begin{proof}
...
\begin{frame}{Context}
    We will now characterize when a continuous operator between $Y'$ and $X'$ is an adjoint operator.
    We need to revise an important corollary from the lecture first.
\end{frame}

\begin{frame}{Revision: Canonical Embedding Properties (i-ii)}
...
\begin{frame}{Revision: Canonical Embedding Properties (iii-iv)}
    \begin{block}{Revision}
        Let $(X, \norm{}{\cdot})$ be a normed \thefield\ vector space. Then we have
        \begin{itemize}
            \item[iii)] $J_X$ is a bounded, linear operator.
            \item[iv)] \canonicalembinv{X} is a bounded, linear operator.
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Revision: Canonical Embedding -- Proof Idea (i-ii)}
...
\begin{frame}{Revision: Canonical Embedding -- Proof Idea (iii)}
    \begin{block}{Proof Idea}
        "iii)": Since $J: X \rightarrow J_X(X), x \mapsto J_X(x)$ is an isometric isomorphism, we have
        \begin{itemize}
...
\begin{frame}{Revision: Canonical Embedding -- Proof Idea (iv)}
    \begin{block}{Proof Idea}
        "iv)": Since $J: X \rightarrow J_X(X), x \mapsto J_X(x)$ is an isometric isomorphism, we have
        \begin{itemize}
...
\begin{frame}{Corollary: Strengthened Bidual Adjoint Embedding -- Proof}
    \begin{proof}
        \begin{enumerateproof}
...
\begin{frame}{Theorem: Characterization of Adjoint Operators -- Proof ($\Leftarrow$) Linearity}
    \begin{proof}

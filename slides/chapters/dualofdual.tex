...
\begin{frame}{Revision: Canonical Embedding Properties -- Proof}
    \begin{block}{Proof}
        \begin{itemize}
            \item[i)] \refertolecture
            \item[ii)] Follows by definition of $J$ and from ''i)''.
            \item[iii)]
...
\begin{frame}{Figure: Strengthened Bidual Adjoint Embedding}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{../figures/dual_of_dual.pdf}
        \caption{

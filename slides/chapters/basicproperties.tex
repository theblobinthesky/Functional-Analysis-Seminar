...
\begin{frame}{Revision: Dual Unit Ball -- Proof}
    \begin{proof}
...
\begin{frame}{Theorem: Properties of Adjoint Operator -- Proof (i)}
    \begin{proof}
        "i)": Let $y' \in Y'$.  Plugging it into the adjoint operator, we get
...
\begin{frame}{Theorem: Properties of Adjoint Operator -- Proof (ii) Linearity}
    \begin{proof}
        "ii)": Let $T_1, T_2 \in \contoperators{X}{Y}, y' \in Y', x \in X, \alpha \in \thefield$. We first prove linearity:
        \begin{align*}
            (\alpha T_1 + T_2)'(y')(x)

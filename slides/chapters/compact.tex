...
\begin{frame}{Definition: Uniformly Equicontinuous and Pointwise Bounded}
    \begin{definition}
        ...
        \begin{enumeratetheorem}
            ...
            \item $M$ is pointwise bounded, if
                $ \forall x \in X: \braces{f(x) \mid f \in M} $ is bounded
        \end{enumeratetheorem}
    \end{definition}
\end{frame}
...
\begin{frame}{Theorem: Schauder -- Proof ($\Rightarrow$) $D$ is compact, $M$ is pointwise bounded}
    \begin{block}{Proof (cont.)}
        \begin{itemize}
            \item $D$ is compact:
                We have \closedunitball{X} is bounded and $T$ is a compact operator.
            ...
            \item $M$ is pointwise bounded: For $x \in \closedunitball{X}$ and $n \in \naturals$ we have
                ...
                $T x_k \convergesto d$ and $\abs{f_n(T x_k)} \le C_1 C_2$. \\
...
\begin{frame}{Theorem: Schauder -- Proof ($\Rightarrow$) Conclusion}
    \begin{block}{Proof (cont.)}
        ...
        \begin{align*}
            \sequence{k}{f_{n(k)} \chain T}
            &= \sequence{k}{y'_{n(k)} \chain T}   \explainstep{apply def. of $f_{n(k)}$} \\
